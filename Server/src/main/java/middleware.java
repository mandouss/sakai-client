...
public class middleware {
    ...
    boolean check_course_id_exist(String course_id) {  //Fangyuan Sun

        return true;
    }

    String box_create_folder(String course_name) {  //Sihao Yao
        return "";
    }

    String box_get_folder_info(String folder_id) {  //Luoyi Li
        return "";
    }
